...
void UMaterialGraph::RebuildGraph()
{
	...
	if (!MaterialFunction)
	{
		...
		MaterialInputs.Add( FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_Anisotropy, Material), MP_Anisotropy, LOCTEXT( "AnisotropyToolTip", "Controls how anisotropic the Material roughness is. Anisotropy of 0 is isotropic. Anisotropy of 1/-1 is maximally anisotropic along the tangent/bi-tangent respectively." ) ) );
		...
		// Toon vars
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecularOffset, Material), MP_SpecularOffset, LOCTEXT("SpecularOffsetToolTip", "Determines ratio of lit to unlit areas")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_SpecularRange, Material), MP_SpecularRange, LOCTEXT("SpecularRangeToolTip", "Specifies specular range")));
		MaterialInputs.Add(FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_ShadowColor, Material), MP_ShadowColor, LOCTEXT("ShadowColorToolTip", "Specifies shadows color")));
