...
static void BuildPropertyToIOIndexMap()
{
	if (PropertyToIOIndexMap.Num() == 0)
	{
		...
		PropertyToIOIndexMap.Add(MP_SpecularOffset,				27);
		PropertyToIOIndexMap.Add(MP_SpecularRange,				28);
		PropertyToIOIndexMap.Add(MP_ShadowColor,					29);
		PropertyToIOIndexMap.Add(MP_ShadingModel,				30);
	}
}
