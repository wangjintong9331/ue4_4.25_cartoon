...
void FMaterialAttributeDefinitionMap::InitializeAttributeMap()
{
	...
	Add(FGuid(0xB8F50FBA, 0x2A754EC1, 0x9EF672CF, 0xEB27BF51), TEXT("Opacity"),			MP_Opacity,			MCT_Float3,	FVector4(1,0,0,0),	SF_Pixel);
...
FText FMaterialAttributeDefinitionMap::GetAttributeOverrideForMaterial(const FGuid& AttributeID, UMaterial* Material)
{
	...
	case MP_Metallic:
		...
		CustomPinNames.Add({MSM_ToonHair, "Specular Lobe2 Strength"});
		CustomPinNames.Add({MSM_ToonAniso, "Offset"});
	...
	case MP_Normal:
		...
		CustomPinNames.Add({MSM_ToonHair, "Tangent" });
	...
	case MP_CustomData0:	
		...
		CustomPinNames.Add({ MSM_Toon, "Shadow Lightener"});
		CustomPinNames.Add({ MSM_ToonSkin, "SSS Mode"});
		CustomPinNames.Add({ MSM_ToonHair, "Tighten Specular"});
		CustomPinNames.Add({ MSM_ToonAniso, "Anisotropy"});
		CustomPinNames.Add({ MSM_Anisotropic, "Anisotropy"});
	...
	case MP_CustomData1:
		...
		CustomPinNames.Add({MSM_ToonSkin, "Offset" });
		CustomPinNames.Add({MSM_ToonHair, "Scatter" });
		CustomPinNames.Add({MSM_ToonAniso, "Anisotropic Rotation" });
		CustomPinNames.Add({MSM_Anisotropic, "Anisotropic Rotation" });
	...
	case MP_SpecularOffset:
		CustomPinNames.Add({ MSM_ToonHair, "Offset"});
		CustomPinNames.Add({ MSM_ToonAniso, "Anisotropic Roughness"});
	...
	case MP_ShadowColor:
		CustomPinNames.Add({MSM_ToonSkin, "Subdermal Color"});
		CustomPinNames.Add({MSM_ToonHair, "Aniso Tangent"});
		CustomPinNames.Add({MSM_ToonAniso, "Aniso Tangent"});
		CustomPinNames.Add({MSM_Anisotropic, "Aniso Tangent"});
